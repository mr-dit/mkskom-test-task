                        ...
                        {images.slice(0, 16).map((image) => (
                            <div key={image.id}>
                                <figure className={style.imageFlex}>
                                    <img src={image.url} alt={image.title} className={style.imageFlex}/>
                                </figure>
                                <div className={style.imageTitle}>{image.title}</div>
                            </div>
                        ))}
                    </div>
                </div>
